...
export default function ProveSection() {
  return (
    <section className="w-full mx-auto flex flex-col items-center mt-32 mb-18 py-0 px-8 transition-all duration-500">
      <h2 className="text-4xl font-semibold mb-6 text-center text-foreground ">The right legal talent, right when you need it.</h2>
