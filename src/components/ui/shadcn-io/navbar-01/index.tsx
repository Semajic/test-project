  ...
  (
    ...
    return (
      <header
        ...
        {...props}
      >
        <div className="container mx-auto flex h-16 max-w-screen-2xl items-center justify-between gap-4 font-poppins">
          {/* Left side */}
            ...
            {isMobile && (
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    className="group h-9 w-9 hover:bg-accent hover:text-accent-foreground font-poppins"
                    variant="ghost"
                    size="icon"
                  >
                    <HamburgerIcon />
                    ...
                    {navigationLinks.map((link, index) => (
                      <NavigationMenuItem key={index} className="w-full">
                        <Button
                          ...
                          className={cn(
                          "flex w-full items-center px-3 py-2 text-sm font-medium transition-colors cursor-pointer no-underline font-poppins",
                          link.active 
