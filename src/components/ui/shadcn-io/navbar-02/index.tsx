      ...
      >
        <div className="container mx-auto flex h-20 max-w-screen-2xl items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              size="sm"
              className="h-12 px-6 text-base text-primary font-extrabold uppercase tracking-wide rounded-full shadow-md bg-transparent border border-primary hover:bg-primary hover:text-background cursor-pointer"
              onClick={(e) => {
                e.preventDefault();
